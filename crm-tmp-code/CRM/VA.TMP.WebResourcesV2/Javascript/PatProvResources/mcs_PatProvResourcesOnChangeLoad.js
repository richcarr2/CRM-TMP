...
retrievemcs_relatedresourceData = function (mcs_relatedresource) {
    ...
    retrievemcs_relatedresourceInfoReq.onreadystatechange = function () {
        retrievemcs_relatedresourceInfoReqCallBack(this);
    };
...
retrievemcs_relatedresourceInfoReqCallBack = function (executionContext, retrievemcs_relatedresourceInfoReq) {
    var formContext = executionContext.getFormContext();
    if (retrievemcs_relatedresourceInfoReq.readyState === 4
    /* complete */
    ) {
        if (retrievemcs_relatedresourceInfoReq.status === 200) {
            ...
            if (retrievemcs_relatedresourceInfo.results[0] != null) {
                ...
                var alertStrings = {
                    ...
                    text: "No records were returned from the copy function, please contact your administrator",
                    title: "Patient Provier Resource Rules."
                };
