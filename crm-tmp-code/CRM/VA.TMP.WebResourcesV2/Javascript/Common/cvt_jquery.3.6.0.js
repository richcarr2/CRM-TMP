            ...
            promise = {
                ...
                then: function (onFulfilled, onRejected, onProgress) {
                        ...
                        return function () {
                            ...
                            mightThrow = function () {
                                ...
                                if (isFunction(then)) {
                                    ...
                                    if (special) {
                                        then.call(
                                        returned, resolve(maxDepth, deferred, Identity, special), resolve(maxDepth, deferred, Thrower, special));
                                        ...
                                        then.call(
                                        returned, resolve(maxDepth, deferred, Identity, special), resolve(maxDepth, deferred, Thrower, special), resolve(maxDepth, deferred, Identity, deferred.notifyWith));
                                    }
                    ...
                    return jQuery.Deferred(function (newDefer) {
                        ...
                        tuples[0][3].add(
                        resolve(
                        0, newDefer, isFunction(onProgress) ? onProgress : Identity, newDefer.notifyWith));

                        // fulfilled_handlers.add( ... )
                        tuples[1][3].add(
                        resolve(
                        0, newDefer, isFunction(onFulfilled) ? onFulfilled : Identity));

                        // rejected_handlers.add( ... )
                        tuples[2][3].add(
                        resolve(
                        0, newDefer, isFunction(onRejected) ? onRejected : Thrower));
                    }).promise();
                },
 ...
 */
    ...
    function getWidthOrHeight(elem, dimension, extra) {
        ...
        elem, dimension, extra || (isBorderBox ? "border" : "content"), valueIsBorderBox, styles,
    ...
    jQuery.each(["height", "width"], function (_i, dimension) {
        jQuery.cssHooks[dimension] = {
            ...
            set: function (elem, value, extra) {
                ...
                elem, dimension, extra, isBorderBox, styles) : 0;
    ...
    jQuery.parseXML = function (data) {
        ...
        if (!xml || parserErrorElem) {
            ...
            parserErrorElem ? jQuery.map(parserErrorElem.childNodes, function (el) {
        ...
        if (Array.isArray(obj)) {
            ...
            jQuery.each(obj, function (i, v) {
                if (traditional || rbracket.test(prefix)) {
                    ...
                    buildParams(
                    prefix + "[" + (typeof v === "object" && v != null ? i : "") + "]", v, traditional, add);
                }
            });
        ...
        if (support.cors || xhrSupported && !options.crossDomain) {
            return {
                send: function (headers, complete) {
                    ...
                    xhr.open(
                    options.type, options.url, options.
                    async, options.username, options.password);
