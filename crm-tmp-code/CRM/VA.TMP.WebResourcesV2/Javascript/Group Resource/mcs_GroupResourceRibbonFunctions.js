function openNewmcs_resource(mcs_relatedsiteid, mcs_relatedsiteidname, mcs_resourcegroupguid) {
    ...
    if ((typeof Xrm !== "undefined") && (typeof Xrm.Utility !== "undefined")) {
        ...
        if (mcs_relatedsiteid !== "") extraqs.push("mcs_relatedsiteid=" + mcs_relatedsiteid);
        if (mcs_relatedsiteidname !== "") extraqs.push("mcs_relatedsiteidname=" + mcs_relatedsiteidname);
        //if (mcs_type !== 0)
...
function QuickCreateResource(formContext) {
    if (formContext !== null) {
        //var formContext = executionContext.getFormContext();
        var relatedSite = formContext.getAttribute("mcs_relatedsiteid") != null ? formContext.getAttribute("mcs_relatedsiteid").getValue()[0] : {
            id: "",
            name: ""
        }; //get the site object or set up an object will empty values
        ...
        if (resourceType === 99999999 || resourceType === 100000000) {
            ...
            var alertStrings = {
                ...
                text: "To Create a Provider/Telepresenter, contact NTTHD at 866-651-3180 or email VHA_NTTHD@va.gov",
                title: "Quick Create Resource Rules."
            };
