...
MCS.cvt_MTSA_OnChange.StoreForward = function (executionContext) {
    ...
    if (SFT) {
        if (formContext.getAttribute("cvt_servicelevels").getValue() == null) formContext.getAttribute("cvt_servicelevels").setValue(917290000);
    }
};
//If the SDK namespace object is not defined, create it.
if (typeof(MCS) == "undefined") {
...
MCS.cvt_MTSA_OnLoad.SetDefaults = function (executionContext) {
    ...
    if (formContext.ui.getFormType() == MCS.cvt_Common.FORM_TYPE_CREATE) {
        ...
        calls.fail(function (err) {}).done(function (data) {
    ...
    if (formContext.getAttribute("cvt_servicesubtype").getValue() != null) MCS.cvt_Common.EnableDependentLookup("cvt_servicetype", "cvt_servicesubtype");
...
MCS.cvt_MTSA_OnSave.CreateName = function (executionContext) {
    ...
    ////Group
    if (cvt_groupappointment == true) {} else {
        //CVT to home
        if (cvt_type == true) {
