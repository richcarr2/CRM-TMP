...
MCS.User_RibbonFunctions.openDialogProcess = function (dialogId, EntityName, objectId) {
    ...
    var url = Xrm.Utility.getGlobalContext().getClientUrl() + "/cs/dialog/rundialog.aspx?DialogId=" + dialogId + "&EntityName=" + EntityName + "&ObjectId=" + objectId;
    //SD - End
...
MCS.User_RibbonFunctions.openLegacyEnableRule = function () {
    var url = window.top.location.href;
    if (url.indexOf("forceclassic") > -1) return false;
    return true;
};
