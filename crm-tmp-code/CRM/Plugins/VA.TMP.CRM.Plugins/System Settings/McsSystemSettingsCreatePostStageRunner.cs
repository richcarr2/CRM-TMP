...
namespace VA.TMP.CRM
{
    public class McsSystemSettingsCreatePostStageRunner : PluginRunner
    {
        ...
        public int CreateSchedulingPackages(mcs_servicetype specialty, mcs_servicesubtype subspecialty, out int exist, out int fail)
        {
            ...
            patientLocationList[2] = (int)cvt_resourcepackagecvt_patientlocationtype.VAVideoConnect;
            patientLocationList[3] = (int)cvt_resourcepackagecvt_patientlocationtype.VAVideoConnect;
            ...
            patientLocationList[6] = (int)cvt_resourcepackagecvt_patientlocationtype.VAVideoConnect;
            ...
            int[] availableTelehealthModalityList = new int[7];
            ...
            availableTelehealthModalityList[2] = (int)cvt_resourcepackagecvt_availabletelehealthmodality.ClinicalVideoTelehealth;
            availableTelehealthModalityList[3] = (int)cvt_resourcepackagecvt_availabletelehealthmodality.StoreandForward;
            availableTelehealthModalityList[4] = (int)cvt_resourcepackagecvt_availabletelehealthmodality.ClinicalVideoTelehealth;
            availableTelehealthModalityList[5] = (int)cvt_resourcepackagecvt_availabletelehealthmodality.StoreandForward;
