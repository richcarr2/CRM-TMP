...
{
    public class GetProvidersStep : IFilter<VideoVisitCreateStateObject>
    {
        ...
        public void Execute(VideoVisitCreateStateObject state)
        {
            ...
            using (var srv = new Xrm(state.OrganizationServiceProxy))
            {
                ...
                if (state.ServiceAppointment.mcs_relatedprovidersite == null) throw new MissingProviderException("No Provider is associated with the service activity");
