    ...
    public class ServiceAppointmentCreatePostStageRunner : PluginRunner
    {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                //////{
                //////    Success = true;
                //////    VeteransChanged = new Dictionary<Guid, bool>();
                //////    Logger.WriteDebugMessage("The Current Facility IS NOT a Vista Facility. Vista Processing halted; Control NOT Passed to Logic App for Cerner Processing as Proxy Adds are not applicable to Cerner integration.");
                //////}
