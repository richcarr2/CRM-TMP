        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                using (var context = new Xrm(OrganizationService))
                {
                    ...
                    var VistaTypeFacility = CernerHelper.CheckIfRelatedCernerFacility(serviceAppointment, context, Logger);
                    ...
                    if (VistaTypeFacility)
                    {
                            ...
                            !CvtHelper.isGfeServiceActivity(serviceAppointment, OrganizationService, Logger))
                        {
                            ...
                            if ((serviceAppointment.StatusCode.Value == (int)serviceappointment_statuscode.Pending) || (serviceAppointment.StatusCode.Value == (int)serviceappointment_statuscode.InterfaceVIMTFailure))
                            {
                                ...
                                if (serviceAppointment.Customers.Count() == 1)
                                {
                                    ...
                                    if (patient != null && patient.cvt_TabletType != null)
                                    {
                                        ...
                                        if (patient.cvt_TabletType.Value == (int)Contactcvt_TabletType.VAIssuediOSDevice && 
                        ...
                        else
                        {
                            ...
                            if (settings.cvt_accenturevyopta == null || !settings.cvt_accenturevyopta.Value) Logger.WriteDebugMessage("Vyopta Integration Bypassed");
                            else if (CvtHelper.isGfeServiceActivity(serviceAppointment, OrganizationService, Logger)) Logger.WriteDebugMessage("Patient Has GFE, No VMR Generated");
                            Success = true;
                        }
                    }
                    else
