    ...
    public class VodUnitTests
    {
        ...
        public void HappyPath()
        {
            ...
            using (ShimsContext.Create())
            {
                ...
                var controller = new StubVmrVodController(_mockLogger, _settings, _mockKeyVaultCert, _mockServiceFactory, _mockTelemetryClient)
                {
        ...
        public void FailWhenRequestIsNull()
        {
            ...
            {
                _mockTelemetryClient = new ShimTelemetryClient();
                var controller = new VmrVodController(_mockLogger, _settings, _mockKeyVaultCert, _mockServiceFactory, _mockTelemetryClient)
                {
                    Request = new StubHttpRequestMessage(),
                    Configuration = new StubHttpConfiguration()
                };
                ...
                ShimHttpResponseMessageExtensions.TryGetContentValueOf1HttpResponseMessageM0Out((HttpResponseMessage rm, out EcVyoptaSMScheduleMeetingResponse r) =>
                {
                    ...
                    r = new EcVyoptaSMScheduleMeetingResponse()
                    {
                        ExceptionMessage = "Error calling VMR VOD Meeting. The request cannot be null",
                ...
                Assert.AreEqual("Error calling VMR VOD Meeting. The request cannot be null", response.ExceptionMessage);
            }
        }
